		...
		<div class="col-lg-6">
			...
			<form class="row g-3">
				<div class="col-md-12">
					...
					<textarea bind:value={prompt} class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
				</div>
				<div class="col">
					<button class="btn btn-primary" {disabled} onclick={start_magic}>Add Prompt To Queue!</button>
				</div>
			</form>
			<br/>
						...
						<div class="card-body">
							<form class="row g-3">
								<div class="col-md-3">
									...
									<input bind:value={model.numCtx} type="number" class="form-control" id="inputNumCtx">
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-3">
									...
									<input bind:value={model.temperature} type="number" class="form-control" id="inputTemperature">
								</div>
								<div class="col-md-2">
