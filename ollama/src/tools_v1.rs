...
fn get_psql() -> Tool {
    ...
    let function = Function {
            ...
            description: "I have access to a postgres server. I can execute SQL queries on a database. If the user wants access to the data from the database the user has to provide a secret for security reasons. The return value will be in JSON format. I can provide a list of tables I have access to, I can provide a list of databases I have access to and I can provide detailed information about the structure of the databases and their tables.".to_string(),
            parameters,
        };
